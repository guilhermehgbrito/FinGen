...
def lista_carteiras(request):
    ...
    return render(
        request,
        "fingen_financeiro/carteiras/lista.html",
        {"carteiras": carteiras},
    )
...
def cria_carteira(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                f'A carteira "{carteira.nome}" foi criada com sucesso!',
            )
            return redirect("lista_carteiras")
        else:
            ...
            return render(
                request,
                "fingen_financeiro/carteiras/criar_editar.html",
                {"form": form},
                status=400,
            )
...
def edita_carteira(request, id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                f'A carteira "{carteira.nome}" foi editada com sucesso!',
            )
            return redirect("lista_carteiras")
        else:
        ...
        return render(
            request,
            "fingen_financeiro/carteiras/criar_editar.html",
            {"form": form, "modo": "edita", "carteira_id": carteira.id},
        )
